...
function App() {
  ...
  useEffect(() => {
    axios.get("http://upgrad-1491629074.us-east-1.elb.amazonaws.com:8001/").then((response) => {
      const { data } = response;
      setEmployees(data.result);
    });

    axios.get("http://upgrad-1491629074.us-east-1.elb.amazonaws.com:8001/departments").then((response) => {
      const { data } = response;
  ...
  const addEmployee = () => {
    ...
    if (name && department && address) {
      axios
        .post("http://upgrad-1491629074.us-east-1.elb.amazonaws.com:8001/", {
          name,
          department,
          address,
        })
  ...
  const updateAddress = (id) => {
    ...
    axios.put(`http://upgrad-1491629074.us-east-1.elb.amazonaws.com:8001/${id}`, data).then((response) => {
      AppToaster.show({
  ...
  const deleteEmployee = (id) => {
    axios.delete(`http://upgrad-1491629074.us-east-1.elb.amazonaws.com:8001/${id}`).then((response) => {
      setEmployees((values) => {
